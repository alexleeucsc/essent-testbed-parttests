...
cpp_merge = "/soe/alexlee/alexlee/essent-testbed-document/essent-testbed-parttests/rocket20/externalPart/merge_debug/logfile_dump/080623_mergeSmallPartsDown_merges_cpp"
cpp_neigh = "/soe/alexlee/alexlee/essent-testbed-document/essent-testbed-parttests/rocket20/externalPart/merge_debug/logfile_dump/080623_mergeSmallPartsDown_neighs_cpp"
...
#print([sorted(mergeIDToMembers_cpp[s]) == sorted(mergeIDToMembers_scala[s]) for s in mergeIDToMembers_cpp].count(False))
