...
int main(int argc, char* argv[]){
    ...
    //std::string fileName = "/soe/alexlee/alexlee/essent-testbed-document/essent-testbed-parttests/essent_extpart/data/092023_boom21_k20_graphDump";
    //std::string fileName = "/soe/alexlee/alexlee/essent-testbed-document/essent-testbed-parttests/essent_extpart/data/092023_rocket20_k20_graphDump";
    std::string fileName;
    fileName = argv[2];
    smallPartCutoff = std::stoi(argv[1]);
    ...
    int totalTimeParting = 0;
    int longestTwoTimeParting = 0;
    ...
    std::cout << "mffc time:" << elapsed_secs << "\n";
    totalTimeParting = totalTimeParting + elapsed_secs;
    //std::cout << "mffc clust count:" << ap.mg.mergeIDToMembers.size();
    //std::cout << "mffc: ";
    for(auto i:mffc){
        //std::cout << i << ",  ";
    }
    ...
    std::cout << "mergeSingleInputPartsIntoParents cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    ...
    std::cout << "mergeSmallSiblings cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    ...
    std::cout << "mergeSmallPartsLayered cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    if(ap.mg.isCyclic()){std::cout<<"problem\n";exit(111);}
    ...
    std::cout << "mergeSmallPartsLayeredDown cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    if(ap.mg.isCyclic()){std::cout<<"problem\n";exit(111);}
    //exit(111);
...
// exit(111);
    ...
    totalTimeParting = totalTimeParting + elapsed_secs;
    longestTwoTimeParting = longestTwoTimeParting + elapsed_secs;
    std::cout << "mergeSmallParts1 clust count:" << ap.mg.mergeIDToMembers.size() << "\n";
    std::cout << "mergeSmallParts1 cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    if(ap.mg.isCyclic()){std::cout<<"problem\n";exit(111);}
    // if(checkIllegalMemberInMapVals(ap.mg.mergeIDToMembers)){
    //     std::cout<<"illegal node found\n";
    // }
    ...
    std::cout << "mergeSmallPartsDown cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    if(ap.mg.isCyclic()){std::cout<<"problem\n";exit(111);}
    ...
    std::cout << "mergeSmallParts2 cycleChecking:" << ap.mg.totalTimeCycleChecking << "\n";
    if(ap.mg.isCyclic()){std::cout<<"problem\n";exit(111);}

    std::cout << "[all partition] took: " << totalTimeParting << "\n";
    std::cout << "[longest two] took: " << longestTwoTimeParting << "\n";
